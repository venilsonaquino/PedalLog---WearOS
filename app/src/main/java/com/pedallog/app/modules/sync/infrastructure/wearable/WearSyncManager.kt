package com.pedallog.app.modules.sync.infrastructure.wearable
...
import com.pedallog.app.shared.util.GzipCsvUtils
...
object WearSyncManager {
    ...
    suspend fun syncSession(
        context: Context,
        session: PedalSessionModel,
        points: List<PedalPointModel>,
        ...
        suspendCancellableCoroutine<Unit> { cont ->
            dataClient.putDataItem(request)
                ...
                .addOnFailureListener { exception ->
                    Log.e(TAG, "Falha ao publicar DataItem: ${exception.message}")
