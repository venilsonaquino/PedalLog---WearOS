 ...
 * Encapsula o estado reativo da interface e centraliza o despacho de comandos
 * para o serviço de rastreamento.
 * Respeita a regra de no máximo 2 atributos do Object Calisthenics.
 */
@HiltViewModel
class RideViewModel @Inject constructor(
    ...
    val gpsSignal: StateFlow<GpsSignal> = TrackingService.gpsSignal
